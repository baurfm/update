...
# Pure, side-effect-free helpers (winget output parsers, formatting, -Only matching) live in a
# separate dot-sourced file so they can be unit-tested in isolation with Pester without pulling
# in this whole script's orchestration/side effects — see tests/update.functions.Tests.ps1.
# $PSScriptRoot resolves correctly whether this runs from a git checkout or an extracted package.
